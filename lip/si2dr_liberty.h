...
si2drVoidT  si2drPISetMessageHandler( si2drMessageHandlerT MsgHandFuncPtr,
	...
	//si2drValueTypeT  si2drComplexValGetValueType        SI2_ARGS(( si2drAttrComplexValIdT attr, si2drErrorT     *err ));
	...
	//si2drExprT      *si2drComplexValGetExprValue        SI2_ARGS(( si2drAttrComplexValIdT attr, si2drErrorT     *err ));
